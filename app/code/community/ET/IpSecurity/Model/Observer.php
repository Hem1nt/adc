...
class ET_IpSecurity_Model_Observer
{
     ...
     * @param $currentIp string
     */
    protected function _processAllowDeny2($allow, $currentIp){
    ...
    protected function _processAllowDeny($allow, $currentIp)
    {
        ...
        // echo $currentIp;
        // print_r($currentIp);
        //echo '<div class="useripaddress" style="display:none;">1. Allowed Ips'.$allow.'<br/>2.Current Ips'.$currentIp.'</div>';
        ...
        if ($this->_redirectBlank == 1 && !$allow) {
            ...
            echo '<html><h1 style="text-align:center;">Access Denied </h1></html>';
    ...
    public function getCurrentIp()
    {
        ...
        */
        $currentIp = Mage::helper('core/http')->getRemoteAddr();//$_SERVER['REMOTE_ADDR'];
        return $currentIp;
    }
