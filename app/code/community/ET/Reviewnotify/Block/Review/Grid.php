<?php
class ET_Reviewnotify_Block_Review_Grid extends Mage_Adminhtml_Block_Review_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        // echo "<pre>"; print_r($model->getCollection()->getData());
        ...
        foreach ($this->getcollection() as $item) 
            $item->ip_tracking = $model->load($item->getReviewId())->getIpTracking();
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('ip_tracking', array(
            'header'    => Mage::helper('review')->__('IP Tracking'),
            'type'      => 'text',
            'index'     => 'ip_tracking',
            'filter'    => false,
            'sortable'  => false
