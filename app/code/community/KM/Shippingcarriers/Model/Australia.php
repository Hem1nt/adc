...
class KM_Shippingcarriers_Model_Australia extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {

    protected $_code = 'australia';
    ...
    public function getAllowedMethods() {
        ...
        return array('australia' => $this->getConfigData('title'));
    }
