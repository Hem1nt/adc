...
class KM_Shippingcarriers_Model_Deutsche extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {

    protected $_code = 'deutsche';
    ...
    public function getAllowedMethods() {
        ...
        return array('deutsche' => $this->getConfigData('title'));
    }
