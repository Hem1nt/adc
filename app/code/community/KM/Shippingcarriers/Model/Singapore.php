...
class KM_Shippingcarriers_Model_Singapore extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {

    protected $_code = 'singapore';
    ...
    public function getAllowedMethods() {
        ...
        return array('singapore' => $this->getConfigData('title'));
    }
