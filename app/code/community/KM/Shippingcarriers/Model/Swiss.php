...
class KM_Shippingcarriers_Model_Swiss extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {

    protected $_code = 'swiss';
    ...
    public function getAllowedMethods() {
        ...
        return array('swiss' => $this->getConfigData('title'));
    }
