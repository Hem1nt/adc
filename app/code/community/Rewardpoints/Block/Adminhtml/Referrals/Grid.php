 ...
 */
class Rewardpoints_Block_Adminhtml_Referrals_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('send_link', array(
            'header'    => Mage::helper('rewardpoints')->__('Send Referal Link'),
            'index'     => 'send_link',
            'width'     => '150px',
             "renderer" =>"Rewardpoints_Block_Adminhtml_Referrals_Renderer_Link",
        ));
