...
class Rewardpoints_Model_Catalogpointrules extends Mage_Rule_Model_Rule
{
    ...
    public function getAllCatalogRulePointsGathered($product = null, $item_default_points = null, $storeId = false)
    {
        $points = $this->getCatalogRulePointsGathered($product, $item_default_points, $storeId);   
        return $points;
    }

    
    public function getCatalogRulePointsGathered($to_validate, $item_default_points = null, $storeId = false)
    {
        $points = 0;
