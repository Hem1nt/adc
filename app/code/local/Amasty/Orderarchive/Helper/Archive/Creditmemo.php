...
class Amasty_Orderarchive_Helper_Archive_Creditmemo extends Amasty_Orderarchive_Helper_Archive_Base
{
    ...
    {
        $this->baseTable = Mage::getResourceModel('sales/order_creditmemo_grid_collection')->getMainTable();
        $this->archiveTable = Mage::getResourceModel('amorderarchive/creditmemoArchive')->getMainTable();
    }
