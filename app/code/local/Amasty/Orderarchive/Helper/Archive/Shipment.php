...
class Amasty_Orderarchive_Helper_Archive_Shipment extends Amasty_Orderarchive_Helper_Archive_Base
{
    ...
    {
        $this->baseTable = Mage::getResourceModel('sales/order_shipment_grid_collection')->getMainTable();
        $this->archiveTable = Mage::getResourceModel('amorderarchive/shipmentGrid')->getMainTable();
    }
