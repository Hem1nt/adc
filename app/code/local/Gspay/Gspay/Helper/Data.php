 ...
 */
class Gspay_Gspay_Helper_Data extends Mage_Payment_Helper_Data
{
    const XML_PATH_EMAIL        = 'payment/gspay/gspay_email';
    const XML_PATH_CUSTOMER_ID  = 'payment/gspay/customer_id';
    const XML_PATH_SECRET_KEY   = 'payment/gspay/secret_key';
