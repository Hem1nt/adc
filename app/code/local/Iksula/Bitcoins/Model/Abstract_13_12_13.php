 ...
 */
abstract class Gspay_Gspay_Model_Abstract extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    protected $_formBlockType = 'gspay/form';
    protected $_infoBlockType = 'gspay/info';
    ...
    {
        return Mage::getUrl('gspay/processing/payment');
    }
