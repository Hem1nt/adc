 ...
 */
class Iksula_Bitcoins_BitcoinsController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Retrieve Gspay helper
     *
     * @return Gspay_Gspay_Helper_Data
     */
    protected function _getHelper()
    {
        return Mage::helper('bitcoins');
    }
    ...
    public function checkemailAction()
    {
        try {
            ...
            if (empty($response)) {
                Mage::throwException('Error: Connection to gspay.com failed');
            }
