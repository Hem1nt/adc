...
class Iksula_Categorysales_Block_Adminhtml_Categorysales extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * This is your module alias
     */
    protected $_blockGroup      = 'iksula_categorysales';
    /**
     * This is the controller's name (this block)
     */
    protected $_controller      = 'adminhtml_categorysales';
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('iksula_categorysales')->__('Custom Category Sales Reports');
        ...
        $this->addButton('filter_form_submit', array(
            'label'     => Mage::helper('iksula_categorysales')->__('Show Report'),
