...
class Iksula_Categorysales_Block_Adminhtml_Filter_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $htmlIdPrefix   = 'iksula_categorysales_';
        $form->setHtmlIdPrefix($htmlIdPrefix);

        // create a fieldset to add elements to
        $fieldset       = $form->addFieldset('base_fieldset', array('legend' => Mage::helper('iksula_categorysales')->__('Filter')));
        ...
        $fieldset->addField('from', 'date', array(
            ...
            'label'     => Mage::helper('iksula_categorysales')->__('From'),
            'title'     => Mage::helper('iksula_categorysales')->__('From')
        ));
        $fieldset->addField('to', 'date', array(
            'name'      => 'to',
            'format'    => $dateFormatIso,
            'image'     => $this->getSkinUrl('images/grid-cal.gif'),
            'label'     => Mage::helper('iksula_categorysales')->__('To'),
            'title'     => Mage::helper('iksula_categorysales')->__('To')
        ));
        $fieldset->addField('category_id', 'select', array(
            'name'      => 'category_id',
            'options'   => $this->_getCategoryOptions(),
            'label'     => Mage::helper('iksula_categorysales')->__('Category')
        ));
    ...
    {
        $options        = array(
            'day'       => Mage::helper('iksula_categorysales')->__('Day'),
            'month'     => Mage::helper('iksula_categorysales')->__('Month'),
            'year'      => Mage::helper('iksula_categorysales')->__('Year'),
        );
    ...
    protected function _initFormValues()
    {
        ...
        $this->getForm()->addValues($filterData);
