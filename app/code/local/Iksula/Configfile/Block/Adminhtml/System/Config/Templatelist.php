<?php
class Iksula_Configfile_Block_Adminhtml_System_Config_Templatelist extends Mage_Core_Block_Html_Select
{
    ...
    protected function _getTemplateList(){
        if (is_null($this->_templateList)) {
            ...
            $collection = Mage::getModel('configfile/system_config_source_email_template')->toOptionArray();
