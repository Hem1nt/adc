...
class Iksula_Epayworxs_Model_Standard extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function getStandardCheckoutFormFields ()
    {
        ...
        Mage::log('----------Start of Order------'.$orderid.'-----------', null, 'epayworks.log');
        Mage::log(json_encode($billingAddress->getData()), null, 'epayworks.log');
        Mage::log(json_encode($order->getData()), null, 'epayworks.log');
        Mage::log(json_encode($shippingAddress->getData()), null, 'epayworks.log');
        Mage::log(json_encode($order_details), null, 'epayworks.log');
        Mage::log('----------End of Order------'.$orderid.'-----------', null, 'epayworks.log');

        // $orderDetails = $order->getRealOrderId().'-----'.$transactionDescription.'--------'.$billingAddress
