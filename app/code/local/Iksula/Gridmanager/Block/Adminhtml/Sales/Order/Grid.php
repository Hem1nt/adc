<?php
class Iksula_Gridmanager_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
	...
	protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(array('sfoa'=>'sales_flat_order_address'), 'main_table.entity_id = sfoa.parent_id AND sfoa.address_type="shipping"',array('sfoa.street', 'sfoa.city','sfoa.region','sfoa.postcode','sfoa.telephone'));
         // echo '<pre>';print_r($collection->setPageSize(20)->setCurPage(1)->getData());exit;
    ...
    protected function _prepareColumns()
    {
        ...
        if (Mage::getSingleton('admin/session')->isAllowed('sales/order/actions/view')) {
          ...
          $this->addColumn('customer_group_id' ,array(
           ...
           'width' => '100',
           'index' => 'sales_flat_order.customer_group_id' ,
