...
require_once Mage::getBaseDir('lib').'/htmltodocx/phpword/PHPWord.php';
require_once Mage::getBaseDir('lib').'/htmltodocx/simplehtmldom/simple_html_dom.php';
require_once Mage::getBaseDir('lib').'/htmltodocx/htmltodocx_converter/h2d_htmlconverter.php';
require_once Mage::getBaseDir('lib').'/htmltodocx/example_files/styles.inc';
...
class Iksula_Orderstatechange_Model_Sales_Order_Pdf_Shipment extends Mage_Sales_Model_Order_Pdf_Shipment
{
    ...
    public function getPdf($shipmentsArray = array())
    {
        ...
        require_once(Mage::getBaseDir('lib') . DS . 'htmltodocx/example.php');
