...
class Iksula_Reports_Block_Adminhtml_Filter_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $htmlIdPrefix   = 'iksula_reports_';
        $form->setHtmlIdPrefix($htmlIdPrefix);

        // create a fieldset to add elements to
        $fieldset       = $form->addFieldset('base_fieldset', array('legend' => Mage::helper('iksula_reports')->__('Filter')));
        ...
        $fieldset->addField('from', 'date', array(
            ...
            'label'     => Mage::helper('iksula_reports')->__('From'),
            'title'     => Mage::helper('iksula_reports')->__('From')
        ));
        $fieldset->addField('to', 'date', array(
            'name'      => 'to',
            'format'    => $dateFormatIso,
            'image'     => $this->getSkinUrl('images/grid-cal.gif'),
            'label'     => Mage::helper('iksula_reports')->__('To'),
            'title'     => Mage::helper('iksula_reports')->__('To')
        ));
    ...
    {
        $options        = array(
            'day'       => Mage::helper('iksula_reports')->__('Day'),
            'month'     => Mage::helper('iksula_reports')->__('Month'),
            'year'      => Mage::helper('iksula_reports')->__('Year'),
        );
