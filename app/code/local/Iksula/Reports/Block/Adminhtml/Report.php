...
class Iksula_Reports_Block_Adminhtml_Report extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * This is your module alias
     */
    protected $_blockGroup      = 'iksula_reports';
    /**
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('iksula_reports')->__('Custom Reports');
        ...
        $this->addButton('filter_form_submit', array(
            'label'     => Mage::helper('iksula_reports')->__('Show Report'),
