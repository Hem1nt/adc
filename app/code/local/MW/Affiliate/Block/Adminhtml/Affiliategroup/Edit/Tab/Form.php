...
class MW_Affiliate_Block_Adminhtml_Affiliategroup_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  ...
  {   
      ...
      $fieldset->addField('limit_day', 'text', array(
           	'label' => Mage::helper('affiliate')->__('Maximum number of days affiliate will earn commission from new referral'),
           	'name'  => 'limit_day',
      	    'required'  => true,
       ...
       $fieldset->addField('limit_order', 'text', array(
           	'label' => Mage::helper('affiliate')->__('Maximum number of orders affiliate will earn commission from new referral'),
           	'name'  => 'limit_order',
      	    'required'  => true,
       		'note' => Mage::helper('affiliate')->__('Insert 0 if no limitation.'),
       		'class' => 'validate-digits',
       	...
       	$fieldset->addField('limit_commission', 'text', array(
           	'label' => Mage::helper('affiliate')->__('Maximum commission affiliate will earn from each referral'),
