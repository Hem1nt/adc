...
class MW_Affiliate_Block_Adminhtml_Affiliatememberpending_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      ...
      $this->setEmptyText(Mage::helper('affiliate')->__('No Affiliate Member Pending Found'));
  }
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('referral_name', array(
          'header'    => Mage::helper('affiliate')->__('Referral Name'),
          'align'     =>'left',
          'index'     => 'customer_id',
      ...
      $this->addColumn('auto_withdrawn', array(
          'header'    => Mage::helper('affiliate')->__('Auto Withdrawal'),
          'align'     =>'left',
   ...
   public function getRowUrl($row)
   {
    ...
    protected function _prepareMassaction()
    {
        ...
        //$statuses = Mage::getModel('affiliate/active')->getOptionArray();
        $statuses = array(
