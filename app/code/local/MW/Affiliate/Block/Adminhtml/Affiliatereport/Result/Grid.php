    ...
    protected function _prepareColumns()
    {
    	$this->addColumn('customer_invited', array(
      	...
      	$this->addColumn('customer_id_count', array(
            'header'    =>Mage::helper('affiliate')->__('Customers'),
            'width'     =>'150px',
            'align'     =>'left',
            'index'     =>'customer_id_count',
        ));
        $this->addColumn('order_id_count', array(
            'header'    =>Mage::helper('affiliate')->__('Orders'),
            'width'     =>'150px',
            'align'     =>'left',
            'index'     =>'order_id_count',
        ));
        $this->addColumn('product_id_count', array(
          	'header'    => Mage::helper('affiliate')->__('Sales Items'),
          	'align'     =>'left',
		...
		$this->addColumn('history_discount_sum', array(
            'header'    =>  Mage::helper('affiliate')->__('Discount Total'),
        	'align'     =>  'center',
			'width'		=>  '150px',
