...
class MW_Affiliate_Model_Mysql4_Affiliateinvitation_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
	...
	{
		$array_status = array(MW_Affiliate_Model_Statusinvitation::CLICKLINK,MW_Affiliate_Model_Statusinvitation::REGISTER,MW_Affiliate_Model_Statusinvitation::PURCHASE);
