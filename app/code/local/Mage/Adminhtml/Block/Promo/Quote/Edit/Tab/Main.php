    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        /* only for timer */
        /*$timerdateFormatIso = Mage::app()->getLocale()->getDateFormat(Mage_Core_Model_Locale::FORMAT_TYPE_SHORT);
        $fieldset->addField('start_date', 'date', array(
          'name'   => 'start_date',
          'label'  => Mage::helper('salesrule')->__('Start Date'),
          'title'  => Mage::helper('salesrule')->__('Start Date'),
          'image'  => $this->getSkinUrl('images/grid-cal.gif'),
          'input_format' => $timerdateFormatIso,
          'format'       => $timerdateFormatIso,
          'time' => true,
          'after_element_html' => 'only for countdown timer'
        ));

        $fieldset->addField('end_date', 'date', array(
          'name'   => 'end_date',
          'label'  => Mage::helper('salesrule')->__('End Date'),
          'title'  => Mage::helper('salesrule')->__('End Date'),
          'image'  => $this->getSkinUrl('images/grid-cal.gif'),
          'input_format' => $timerdateFormatIso,
          'format'       => $timerdateFormatIso,
          'time' => true,
        ...
        /*$fieldset->addType('text', 'Iksula_Countdowntimer_Block_Adminhtml_Promo_Custom_Start');*/     
       /* $fieldset->addField('start_date', 'text', array(
            'name'      => 'start_date',
            'label'     => Mage::helper('salesrule')->__('Start Date'),
        ));
        $fieldset->addType('text', 'Iksula_Countdowntimer_Block_Adminhtml_Promo_Custom_End');     
