...
class Mageplace_Freshdesk_Block_Customer_Ticket_Abstract extends Mage_Core_Block_Template
{
    ...
    {
        return $this->getUrl('helpdesk/ticket/create');
    }

    public function getViewUrl($ticket)
    {
        return $this->getUrl('helpdesk/ticket/view', array('ticket_id' => $ticket->getDisplayId()));
    }

    public function getCloseUrl($ticket)
    {
        return $this->getUrl('helpdesk/ticket/close', array('ticket_id' => $ticket->getDisplayId()));
    }
}
