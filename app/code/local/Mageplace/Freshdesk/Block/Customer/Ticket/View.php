...
class Mageplace_Freshdesk_Block_Customer_Ticket_View extends Mageplace_Freshdesk_Block_Customer_Ticket_Abstract
{
    ...
    {
        return $this->getUrl('helpdesk/ticket/refresh', array('ticket_id' => $this->getTicket()->getId()));
    }
    ...
    {
        return $this->getUrl('helpdesk/ticket/reply', array('ticket_id' => $this->getTicket()->getId(), 'message' => $this->getMessageTag()));
    }
