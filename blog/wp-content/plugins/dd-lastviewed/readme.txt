...
Tags: History, Last, Viewed, posts, custom, posttypes, thumbnail, cookie, widget, recent, visit, visited, recently, terms, taxonomies, taxonomy, term, category
...
If one of the posts with the filtered types or terms gets visited in the front, a cookie gets set/update with an array of visited ids. Each widget has his own cookie, so you can set as many widgets as you want.
