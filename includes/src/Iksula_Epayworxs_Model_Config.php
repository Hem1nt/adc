 ...
 */
/**
 * epayworxs Configuration Model
 *
 * @category   Mage
 * @package    Iksula_Epayworxs
 * @name       Iksula_Epayworxs_Model_Config
 * @author     Magento Core Team <core@magentocommerce.com>
 */

class Iksula_Epayworxs_Model_Config extends Varien_Object
{
    /**
     *  Return config var
     *
    ...
    {
        if (!$this->hasData($key)) {
            $value = Mage::getStoreConfig('payment/epayworxs_standard/'.$key);
    ...
    {
        return $this->getConfigData('module_version');
    }
 ...
 /**
    ...
    /**
     *  Return Store description sent to epayworxs
     *
