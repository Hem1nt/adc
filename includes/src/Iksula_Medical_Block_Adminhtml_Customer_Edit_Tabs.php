<?php
class Iksula_Medical_Block_Adminhtml_Customer_Edit_Tabs extends Mage_Adminhtml_Block_Customer_Edit_Tabs
{
	protected function _beforeToHtml()
    {
        ...
        if (Mage::registry('current_customer')->getId()) {
            ...
            if (Mage::getSingleton('admin/session')->isAllowed('catalog/tag')) {
             ...
             $this->addTab('medical', array(
                'label'     => Mage::helper('customer')->__('Medical Observation'),
                'class'     => 'ajax',
                'url'       => $this->getUrl('*/*/medical', array('_current' => true)),
            ));
        }
