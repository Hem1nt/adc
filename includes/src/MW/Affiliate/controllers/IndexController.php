...
{   
    ...
    {   
    	...
    	//$referral_edit->setActive(MW_Affiliate_Model_Statusactive::ENABLED);
    	...
    	$this->_getSession()->addSuccess($this->__("You have successfully updated referral account"));
    	$this->_redirect('affiliate/index/referralaccount/');		
    }
    ...
    {   
    	...
    	if($check_affiliate){
	    	...
	    	$this->_getSession()->addSuccess($this->__("You have successfully saved referral account"));
	    	$this->_redirect('affiliate/index/referralaccount/');				
    	}
    	else 
    	{
    ...
    public function withdrawnsubmitAction()
	{
		if ($this->getRequest()->isPost())
		{
			...
			// gia nay da dc convert o form roi
			$withdrawn_amount = (double)$post["withdraw_amount"];
			//$currency=$post["currency"];
			//echo $withdraw_amount;exit;
			$withdraw_receive = $withdrawn_amount - $fee;
			...
			$withData  =  array('customer_id'=>$customerid,
