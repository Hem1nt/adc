...
class MW_Affiliate_Block_Adminhtml_Affiliatebanner_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
  	//var_dump(Mage::getSingleton('adminhtml/session')->getinvitationGrid()); exit;
  	  //unset($_SESSION['invitationGridfilter']); exit;
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('width', array(
			'header'    => Mage::helper('affiliate')->__('Width'),
			'width'     => '150px',
			'index'     => 'width',
      ));
      $this->addColumn('height', array(
			'header'    => Mage::helper('affiliate')->__('Height'),
			'width'     => '150px',
			'index'     => 'height',
      ));
     // $this->addColumn('image_name', array(
		//	'header'    => Mage::helper('invitation')->__('Image name'),
		//	'width'     => '150px',
			//'index'     => 'image_name',
     // ));
