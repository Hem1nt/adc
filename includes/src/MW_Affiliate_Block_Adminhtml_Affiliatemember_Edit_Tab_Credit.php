   ...
   {   
        ...
        $fieldset->addField('credit', 'label', array(
       	...
       	$fieldset->addField('amount_credit', 'text', array(
           	'label' => Mage::helper('affiliate')->__('Credit change'),
           	'name'  => 'amount_credit',
       		'note' => Mage::helper('catalog')->__('Amount of Credit which you want to add or subtract. Ex. 50, -50.'),
       		'class' => 'validate-number',
       	));
       	
       	$fieldset->addField('payout_credit', 'text', array(
           	'label' => Mage::helper('affiliate')->__('Payout'),
           	'name'  => 'payout_credit',
       	...
       	$fieldset->addField('comment', 'textarea', array(
           	'label' => Mage::helper('affiliate')->__('Comment'),
           	'name'  => 'comment',
       	));
