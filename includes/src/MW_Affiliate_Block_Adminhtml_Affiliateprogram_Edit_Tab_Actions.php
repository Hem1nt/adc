...
//    }
    ...
    protected function _prepareForm()
    {
		...
		$fieldset = $form->addFieldset('action_fieldset', array('legend'=>Mage::helper('affiliate')->__('Update prices using the following information')));
       ...
       $fieldset->addField('discount', 'text', array(
        ...
        $fieldset = $form->addFieldset('actions_fieldset', array(
            'legend'=>Mage::helper('affiliate')->__('Apply the rule only to cart items matching the following conditions (leave blank for all items)')
