...
class MW_Affiliate_Model_Type extends Varien_Object
{
    ...
    static public function getOptionArray()
    {
        return array(
            ...
            self::REGISTERING   		=> Mage::helper('affiliate')->__('Invited Customer Register'),
            self::BUY_PRODUCT    		=> Mage::helper('affiliate')->__('Invited Customer Buys Product'),
            self::REFUND_PRODUCT    	=> Mage::helper('affiliate')->__('Invited Customer Refunds Product'),
