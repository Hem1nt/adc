...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        //echo $collection->getData();exit;
		$this->setCollection($collection);
        return parent::_prepareCollection();
	/*$collection = Mage::getResourceModel($this->_getCollectionClass());
	
		//$collection->getSelect()->join('sales_flat_shipment_track', 'sales_flat_order_grid.entity_id = sales_flat_shipment_track.order_id',array('track_number'));
		/* array('lk'=>$resource->getTableName('sales_flat_order_address/sales_flat_order_address')),
                     'lk.parent_id = main_table.entity_id',
                      array('lk.postcode')
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn('echeck_transactionid', array(
			...
			'filter_index' => 'sales_flat_order.echeck_transactionid',
        ));
	...
	/*$this->addColumn('postcode', array(
        ...
        $this->addColumn('grand_total', array(
			...
			'filter_index' => 'sales_flat_order.grand_total',
        ));
