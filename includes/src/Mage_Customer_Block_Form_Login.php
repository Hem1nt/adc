...
class Mage_Customer_Block_Form_Login extends Mage_Core_Block_Template
{
    ...
    {
		 if ($this->getLayout()->getBlock('head')) $this->getLayout()->getBlock('head')->setTitle(Mage::helper('customer')->__('Customer Login')); 
       // $this->getLayout()->getBlock('head');//->setTitle("Customer Login");
