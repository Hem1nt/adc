...
IWD.OPC = {
		...
		validatePayment: function(){
			// specially for echeckpayment method discount issue
			if($j_opc("#co-payment-form input[type='radio']:checked").val() == "echeckpayment"){
				IWD.OPC.savePayment();
			}

			if($j_opc("#co-payment-form input[type='radio']:checked").val() == "echeckapi"){
				IWD.OPC.savePayment();
			}
...
IWD.OPC.Billing = {
		...
		save: function(){
			...
			// var validShipping = IWD.OPC.Shipping.validateAddressForm();
			// if(validShipping){
			// }
		},
